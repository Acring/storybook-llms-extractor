    ...
    stories: {
      ...
      'components-accordion--with-icon': {
        ...
        parameters: {
          ...
          fullSource:
            'import * as React from "react";\nimport { RocketRegular } from "@acring/react-icons";\n\nimport {\n  Accordion,\n  AccordionHeader,\n  AccordionItem,\n  AccordionPanel,\n} from "@acring/react-components";\n\nexport const WithIcon = () => (\n  <Accordion>\n    <AccordionItem value="1">\n      <AccordionHeader icon={<RocketRegular />}>\n        Accordion Header 1\n      </AccordionHeader>\n      <AccordionPanel>\n        <div>Accordion Panel 1</div>\n      </AccordionPanel>\n    </AccordionItem>\n    <AccordionItem value="2">\n      <AccordionHeader icon={<RocketRegular />}>\n        Accordion Header 2\n      </AccordionHeader>\n      <AccordionPanel>\n        <div>Accordion Panel 2</div>\n      </AccordionPanel>\n    </AccordionItem>\n    <AccordionItem value="3">\n      <AccordionHeader icon={<RocketRegular />}>\n        Accordion Header 3\n      </AccordionHeader>\n      <AccordionPanel>\n        <div>Accordion Panel 3</div>\n      </AccordionPanel>\n    </AccordionItem>\n  </Accordion>\n);\n',
        },
      },
    },
  },
